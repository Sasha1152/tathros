...
class Category(TimeStampedModel, SoftDeletableModel):
    ...
    photographers = models.ManyToManyField('Photographer', blank=True, related_query_name='category')
    photos = models.ManyToManyField('Photo', blank=True, related_query_name='category')
